!(function (o) {
    "use strict";
    var r = document.getElementById("line-chart-01").getContext("2d");
    new Chart(r, {
        type: "line",
        data: {
            labels: ["شهریور", "مهر", "آبان", "آذر", "دی"],
            datasets: [
                {
                    label: "فروش",
                    borderColor: "#08a6c3",
        ...
        options: {
            ...
            scales: {
                yAxes: [
                    {
                        ticks: { display: !0, beginAtZero: !0 },
                        gridLines: { drawBorder: !0, display: !0 },
                    },
                ],
                xAxes: [
                    {
        ...
        (r = document.getElementById("line-chart-02").getContext("2d")),
        new Chart(r, {
            type: "line",
            data: {
                labels: ["شهریور", "مهر", "آبان", "آذر", "دی"],
        ...
        (r = document.getElementById("area-chart-01").getContext("2d")),
        new Chart(r, {
            type: "line",
            data: {
                labels: ["شهریور", "مهر", "آبان", "آذر", "دی"],
        ...
        (r = document.getElementById("area-chart-02").getContext("2d")),
        new Chart(r, {
            type: "line",
            data: {
                labels: ["شهریور", "مهر", "آبان", "آذر", "دی"],
        ...
        (r = document.getElementById("vertical-chart-01").getContext("2d")),
        new Chart(r, {
            type: "bar",
            data: {
                labels: ["شهریور", "مهر", "آبان", "آذر", "دی"],
        ...
        (r = document.getElementById("vertical-chart-02").getContext("2d")),
        new Chart(r, {
            type: "bar",
            data: {
                labels: ["شهریور", "مهر", "آبان", "آذر", "دی"],
        ...
        (r = document.getElementById("horizontal-chart-01").getContext("2d")),
        new Chart(r, {
            type: "horizontalBar",
            data: {
                labels: ["شهریور", "مهر", "آبان", "آذر", "دی"],
        ...
        (r = document.getElementById("horizontal-chart-02").getContext("2d")),
        new Chart(r, {
            type: "horizontalBar",
            data: {
                labels: ["شهریور", "مهر", "آبان", "آذر", "دی"],
        ...
        (r = document.getElementById("doughnut-chart").getContext("2d")),
        new Chart(r, {
            type: "doughnut",
            data: {
                labels: ["آبی", "سبز", "قرمز"],
        ...
        (r = document.getElementById("pie-chart").getContext("2d")),
        new Chart(r, {
            type: "pie",
            data: {
                labels: ["آبی", "سبز", "قرمز"],
        ...
        (r = document.getElementById("radar-chart").getContext("2d")),
        new Chart(r, {
            type: "radar",
            data: {
        ...
        (r = document.getElementById("polar-chart").getContext("2d")),
        new Chart(r, {
            type: "polarArea",
            data: {
                labels: ["آبی", "سبز", "قرمز", "بنفش"],
                datasets: [
                    {
                        label: "برچسب",
                        backgroundColor: [
